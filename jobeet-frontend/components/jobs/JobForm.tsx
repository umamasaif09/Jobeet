      ...
      <form onSubmit={handleSubmit} className={styles.form}>
        <div className="flex flex-col gap-[8px]">
          ...
          >
            <SelectTrigger className={styles.formSelectInput}>
              {categories.find((c) => c.id.toString() === job.category_id)
          ...
          >
            <div className="flex gap-4 max-[433]:gap-2">
              <div className="flex gap-2 max-[433]:gap-1">
                ...
                <Label htmlFor="full" className={styles.radioLabel}>
                  Full-time
                </Label>
              </div>
              <div className="flex gap-2 max-[433]:gap-1">
                <RadioGroupItem value="Part-time" id="part" />
                <Label htmlFor="part" className={styles.radioLabel}>
                  Part-time
                </Label>
              </div>
              <div className="flex gap-2 max-[433]:gap-1">
                <RadioGroupItem value="Freelance" id="free" />
                <Label htmlFor="free" className={styles.radioLabel}>
                  Freelance
                </Label>
              </div>
            </div>
        ...
        <div className="flex flex-col gap-[8px]">
          ...
          <div className="flex flex-col items-start gap-[8px]">
            ...
            <Label htmlFor="logo-upload" className={styles.fileButton}>
              Choose File
            </Label>
          </div>
        ...
        <div className="flex flex-col gap-[8px]">
          <Label className={styles.formLabel}>
            How to Apply <span className={styles.required}>*</span>
          </Label>
          <Textarea
            rows={5}
        ...
        <div className="flex items-center gap-2">
          <Checkbox
            ...
            onCheckedChange={(checked) =>
              updateField("is_public", Boolean(checked))
            }
          />

          <Label htmlFor="checked" className={styles.checkboxLabel}>
            Public Job Listing
          </Label>
        </div>

        <div className="flex justify-end">
          <Button type="submit" className={styles.jobButton}>
            {mode == "create" && userType == "admin"
              ? "Create"
              : mode == "create" && userType == "public"
                ? "Preview"
                : "Update"}
          </Button>
        </div>
